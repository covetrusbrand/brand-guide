...
**Brand Philosophy:** Our brand is one of the most valuable assets we have. Every time someone encounters our name, our work, or our content, whether in a product, a proposal, a social post, or an AI-generated output, they form an impression of who we are.
...
Before the logo, the colors, and the type system, there is a story about who Covetrus is and who we serve. This is the foundation that everything else stands on.

### Our Name

Covetrus is more than a name — it is a declaration of who we are and who we serve. The name is composed of three words that together define our purpose and come to life in our icon.

- **co (CoWorking, Vet Blue):** We operate as true partners — alongside veterinarians, not above them.
- **vet (Veterinarians, Care Red):** They are at the center of everything we do, and our name makes that visible.
- **us (Us, Tech Teal):** A team of dedicated professionals unified in our commitment to support the people who care for animals.

**Mission:** To drive better financial and clinical outcomes for veterinarians.

**Who we are:** Covetrus is a global, tech-enabled practice improvement company committed to driving better financial and clinical outcomes for veterinarians. From pre-visit to post-appointment, our connected solutions help practices operate more efficiently and profitably across every stage of the patient journey, so veterinary teams can focus on delivering exceptional care for the people and pets that count on them.

**What we do — The Covetrus® Platform:** Unleashing the full potential of veterinarians. The Covetrus Platform optimizes every touchpoint for a seamless connected care experience, freeing practices to focus on what matters most: the pets and pet parents they care for.

**How we do it:** We partner with vets to advance the animal health industry. Covetrus recognizes the challenges veterinary clinics face in today's competitive environment. Together with vets, we're reimagining the future of animal healthcare — bringing innovative solutions to market that streamline operations, empower teams, and fuel their passion to improve the health and well-being of animals.

### Our Brand Architecture

This hierarchy is the organizing framework for all Covetrus brands, platforms, products, and programs. It is split across two key areas: **For Veterinarians** (B2B, the core of our business) and **For Pet Parents** (B2C, our growing consumer-facing presence). This structure is the foundation for how we think, talk, and show up — and it should guide every brand and communications decision.

**For Veterinarians:**

- **Covetrus (Masterbrand):** The umbrella under which everything lives. It carries the full weight of our identity, reputation, and promise.
- **VetSuite (Network Program):** More than a rebate program — VetSuite is how we walk the talk as the honest vet champion, empowering independent veterinarians to run thriving practices, save money, and reclaim time for themselves and their families.
- **Pulse (Foundational Platform):** The heartbeat of the veterinary practice. Pulse brings all software applications together into a cloud-based veterinary operating system (vOS™), giving practices one connected place to run their business.
- **vRxPro® (Online Pharmacy):** A flagship point solution within the Covetrus platform. vRxPro helps practices keep more prescriptions in-house, grow pharmacy revenue, and strengthen client connection — through a practice-branded online storefront, personalized digital outreach, and digital workflows that make prescribing faster and easier. From setup to storefront in as little as one day.
- **Point Solutions (Integrations):** Tech applications that integrate seamlessly with Pulse, or with other practice information management systems — all designed to help veterinary teams run thriving, efficient practices.

---

## 3. Our Creative Principles

These four principles guide every creative and communications decision we make, across design, copy, campaigns, product, and AI-generated content. They are not aspirational, they are operational. Every piece of work, in every medium, should be measured against them.

### 01 — Keep it simple

Veterinary medicine is already challenging. Engaging with Covetrus should never add to that complexity. Our design is clean, bold, and built for impact. Our copy is clear, direct, and free of jargon. Whether someone is reading a headline, navigating a product interface, or scanning a one-pager, the experience should feel effortless. If it takes effort to understand, it needs another pass.

### 02 — Build connections

We design and write for real people. We speak directly to our customers in authentic language and imagery, meeting them where they are in the way they want to be met. Visually, we create work that feels human and relevant. In copy, we lead with their world, not ours. We are at our best when our work is genuinely about our customer, not ourselves.

### 03 — Be trustworthy

Trust is earned through consistency, in how we look, how we sound, and how we show up over time. Our design is reliable and clear. Our copy is honest, substantiated, and never overstated. We do not make claims we cannot support. We lead with empathy, and we treat our customers as the capable professionals they are. When they trust us, we are able to create extraordinary experiences and real results.

### 04 — Listen actively

The best creative work comes from understanding, not assumption. We stay close to our customers through research, experimentation, and genuine curiosity. In design, that means testing and iterating. In copy, that means using the language our customers actually use, not the language we wish they used. The more we listen, the greater our impact.
...
**Do:** Use Arial as the standard fallback for environments where Mulish cannot be rendered, most notably Microsoft Outlook and email clients.

**Don't:** Substitute decorative, serif, or system-default fonts like Calibri or Times New Roman, as these are inconsistent with our brand aesthetic.
...
Our lifestyle photography style reflects who we are: genuine, compassionate, and tech forward. Every image should feel authentic and relatable, never staged or overly polished.

The Covetrus library is shown in the HTML guide. To explore more photography for other sub-brands, use the brand buttons in the Sub-Brand Photography section, or see the Brand in Action section.
...
Our B2B icon style is two-color, rounded, and simple — capturing the professional and approachable aesthetic of our brand. Each icon combines an outline with a single filled element that breaks the line. We never use fully filled icons. Outlines can be black, vet blue, or white, paired with a branded accent color. When pairing colors, ensure sufficient contrast between the icon and its background.

Each icon is downloadable as SVG or PNG. Use SVG for crisp rendering at any size; PNG is appropriate for presentations and places where a transparent background is needed.

### Icon Style
- Each icon combines an **outline** with a **single filled element** that breaks the line. Never use fully filled icons.
- Outlines can be **black**, **vet blue**, or **white**, paired with a branded accent color.
...
- Keep accessibility in mind: ensure sufficient contrast between the icon and its background.

---

## 9. Voice, Tone & Legal Language Guide
...
Real examples of how our brand elements come together as the Covetrus brand. The HTML version of this guide includes a Covetrus showcase image and a "Covetrus Sub-Brands" grid below it; clicking any sub-brand tile expands a panel with that brand's logos, colors, photography, voice & tone, and design examples. The descriptions below summarize what each sub-brand panel contains so AI tools have context for the types of work each produces.

### Covetrus

The Covetrus parent brand's photography library is in section 7 (Photography). A composed showcase image of Covetrus brand-in-action examples will be added to the HTML guide.

### Covetrus Sub-Brands

The following sub-brands each have their own panel in the HTML guide, structured as: Logos → Colors → Photography → Voice & Tone → Design Examples.

### VetSuite

VetSuite brand-in-action examples include:
- **Email campaign:** "What is your practice missing?" with CTA "See what's possible" — designed to drive practice owners to learn more about the program
- **Network stats infographic:** Headline metrics including "1 in 10 veterinarians have already joined VetSuite," "$30M in total savings," "25% profit margin compared to non-member practices," and "50 hours gained per month"
- **Customer quote cards:** Testimonial layouts featuring real practice voices (e.g., Animal Medical Center, Frankfort KY; Cole Grieves, Candlewood Veterinary Clinic, Manhattan KS)
- **Social tiles:** Short-form graphics including "$25,000 — what could an annual savings of $25,000 mean for your clinic?" and "Real practices. Real results."
- **Outcome stat graphics:** Standalone figures like "78% of pet parents returned to make repeat purchases"

Visual hallmarks: navy and teal palette, bold sans-serif numbers, photographic imagery with subtle blue overlay treatments, "Real *results*" script-underline accent.

### GreatPet Care

#### GreatPet Care Logo Variants
| Variant | File | Formats | Usage |
|---|---|---|---|
| Horizontal – RGB | `GreatPetCare_HZ_RGB` | SVG, PNG, JPG | Primary use on white/light backgrounds |
| Horizontal – Knockout (KO) | `GreatPetCare_HZ_KO` | SVG, PNG | Use on dark or colored backgrounds |
| Stacked – RGB | `GreatPetCare_Stacked_RGB` | SVG, PNG, JPG | Stacked layout for light backgrounds |
| Stacked – Knockout (KO) | `GreatPetCare_Stacked_RGB_KO` | SVG, PNG | Stacked layout for dark backgrounds |
| Restricted – RGB | `GreatPetCare_Restricted_RGB` | SVG, PNG, JPG | Compact mark for small or constrained spaces |
| Restricted – Knockout (KO) | `GreatPetCare_Restricted_RGB_KO` | SVG, PNG | Compact mark for dark backgrounds |

GreatPet Care brand-in-action examples include:
- **Pet parent portal hero:** "Manage your pet's healthcare from anywhere with our new pet parent portal" with a "Get Started" CTA
- **Feature highlight cards:** Individual treatments for Access Vaccine Records, Fill Approved Prescriptions, View Invoices, and "+ Much More" (weight tracker, medication reminders, educational articles)
- **Care-from-anywhere infographic:** A "What's inside" feature grid covering Schedule Appointments, Access Vaccine Records, Fill Approved Prescriptions, View Invoices
- **Educational graphics:** Content like "How Veterinary Diets Can Help" with icon-led benefit breakdowns (weight loss, skin health, gut health, bladder health)
- **Parasite Prevention Guide:** Editorial layout including regional risk maps, heartworm hazards, and tick threat content
- **Community campaign:** "Be Part of the GreatPetCare Community" social/campaign graphic encouraging UGC submissions to @greatpetcareofficial, @dogsofinstagram, @dogsoftiktok

Visual hallmarks: GreatPet Green and soft blue palette, rounded photo treatments, circular icon containers, friendly editorial layouts, B2C-warm tone.
...
## 13. Internal Document Standards
...
## 14. Using This Guide With AI Tools
...
*Consistency is what turns individual moments into a recognizable, trustworthy identity. Any assets intended for external release should be reviewed and approved by Creative before going out. Materials that represent the company publicly should be reviewed by Legal to protect both the business and the credibility of the brand. Legal and Creative are here to help, not slow you down.*
***It's always faster to ask first than to fix it after.***
