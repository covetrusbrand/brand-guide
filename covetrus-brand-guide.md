...
Real examples of how our brand elements come together across our product lines. The HTML version of this guide includes a Covetrus showcase at the top and a "Covetrus Sub-Brands" grid below it; clicking any sub-brand tile expands a panel with that brand's logos, colors, photography, voice & tone, and design examples. The descriptions below summarize what each sub-brand panel contains so AI tools have context for the types of work each produces.
